...
var addItemOverview = function(loaded){
    ...
    content.innerHTML += "<item class='overview transition " + tags + "' onclick= 'loadThis(\"" + iObj.id + "\");'><img class='overview' src='" + iObj.thumbnail + "'><p class='subtext overview'>" + iObj.title + "<br>" + iObj.client + "</p></item>";
